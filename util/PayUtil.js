...
module.exports = {
	...
	createSign(obj) {
		...
		// &total_fee=1
		// &trade_type=JSAPI
		const stringA = `appid=${obj.appid}&body=${obj.body}&mch_id=${obj.mch_id}&nonce_str=${obj.nonce_str}&notify_url=${obj.notify_url}&openid=${obj.openid}&out_trade_no=${obj.out_trade_no}&spbill_create_ip=${obj.spbill_create_ip}&total_fee=${obj.total_fee}&trade_type=${obj.trade_type}`;
	...
	createBackSign(obj) {
		...
		const stringA = `appid=${obj.appid}&mch_id=${obj.mch_id}&nonce_str=${obj.nonce_str}&out_refund_no=${obj.out_refund_no}&out_trade_no=${obj.out_trade_no}&refund_fee=${obj.refund_fee}&total_fee=${obj.total_fee}`;
		let stringSignTemp = `${stringA}&key=${obj.key}`;
		stringSignTemp = md5(stringSignTemp).toUpperCase();
		return stringSignTemp;
	},
